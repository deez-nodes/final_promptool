<template>
  <div class="flex-1 flex min-h-0 overflow-hidden bg-bg text-text font-mono text-xs select-none">
    <!-- ── Left Sidebar: Prompt Documents & Section Library ── -->
    ...
    <!-- ── Center Editor: Interactive AST Section Composer ── -->
      ...
      <template v-if="promptStore.currentPrompt.value">
        ...
        <div id="sections" class="space-y-3.5">
          ...
          >
            ...
            <!-- Section Body Textarea with Tab Autocomplete -->
    ...
    <!-- ── Right Preview Pane: Multi-Target AST Compiler ── -->
...
const formattedOutput = computed(() => {
  ...
  // Syntax highlight XML tags or JSON syntax
  ...
  // Highlight {{variables}} in cyan/acid
