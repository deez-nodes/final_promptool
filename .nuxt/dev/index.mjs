...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///app/applet/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, join, dirname } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///app/applet/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///app/applet/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///app/applet/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///app/applet/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///app/applet/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///app/applet/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///app/applet/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///app/applet/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///app/applet/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///app/applet/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///app/applet/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///app/applet/node_modules/unstorage/drivers/fs.mjs';
import { mkdir, writeFile, rename, unlink, readFile } from 'node:fs/promises';
import fsDriver from 'file:///app/applet/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///app/applet/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///app/applet/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///app/applet/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///app/applet/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///app/applet/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///app/applet/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///app/applet/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///app/applet/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///app/applet/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///app/applet/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///app/applet/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///app/applet/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///app/applet/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///app/applet/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///app/applet/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///app/applet/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///app/applet/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///app/applet/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///app/applet/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/app/applet/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/app/applet","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/app/applet/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', cacheDriver({"base":"/app/applet/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/app/applet/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/app/applet/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/app/applet/.data/kv"}));
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"RevX Browser-Based IDE for Polkadot Rust Smart Contracts & PrompTool Prompt Engineering Studio"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=JetBrains+Mono:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=Orbitron:wght@600;700;800;900&family=Rajdhani:wght@500;600;700&family=Inter:wght@300;400;500;600;700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"RevX // Smart Contract IDE & PrompTool"};
...
const _uIO6fnQZeoQg9KsmTr1pawihNHQRzfiF4S6rGGCcXOI = (nitroApp) => {
...
const plugins = [
  _uIO6fnQZeoQg9KsmTr1pawihNHQRzfiF4S6rGGCcXOI,
...
const _8qnqn9 = eventHandler((event) => {
...
const _lazy_4muNfv = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _8qnqn9, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_4muNfv, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_4muNfv, lazy: true, middleware: false, method: undefined }
];
